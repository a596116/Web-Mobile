<template>
  <div>
    ...
    >
      <div
        class="min-h-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left"
      >
        <div class="w-full md:w-1/2">
          ...
          <div class="mb-20 md:mb-0">
            ...
            >
              <i class="mdi mdi-arrow-left mr-2"></i>首頁
            </router-link>
          </div>
        </div>
